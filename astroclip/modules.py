...
class MLP(nn.Module):
    ...
    def __init__(
        ...
        self.decoder = nn.Linear(hidden_features, self.out_features, bias=bias)
...
class TransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        self.mlp = MLP(in_features=embedding_dim, hidden_features=hidden_dim, activation=nn.GELU(), dropout=dropout, bias=bias)
