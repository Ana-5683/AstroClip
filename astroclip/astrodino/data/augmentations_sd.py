...
class DataAugmentationAstroDINO(object):
    def __init__(
        ...
        # sd
        self.norm = transforms.Normalize(mean=[0.00379948, 0.00609522, 0.00919202, 0.01270878, 0.01900207],
...
class GaussianNoise:
    ...
    def __init__(
        ...
        # sd
        self.shape_dist = np.array(
            [0.29143041372299194, 0.4199959933757782, 0.4760073125362396, 0.18615630269050598, 0.3188919126987457])
        self.loc_dist = np.array([0.0180412, 0.0114491, 0.0197659, 0.0140366, 0.0757147])
        self.scale_dist = np.array(
            [0.026180900633335114, 0.005119100213050842, 0.0065052998252213, 0.03008349984884262, 0.09446889907121658])
