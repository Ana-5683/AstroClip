...
class DataAugmentationAstroDINO(object):
    def __init__(
        ...
        # mine
        self.norm = transforms.Normalize(mean=[0.00394422, 0.00634838, 0.00951161, 0.01322077, 0.01987493],
...
class GaussianNoise:
    ...
    def __init__(
        ...
        # mine
        self.shape_dist = np.array(
            [0.2872959077358246, 0.42119720578193665, 0.3188141882419586, 0.005778400227427483, 0.32396620512008667])
        self.loc_dist = np.array([0.0179192, 0.0115271, 0.0174764, -0.9712915, 0.078045])
        self.scale_dist = np.array(
            [0.026063499972224236, 0.005000799894332886, 0.008911900222301483, 1.0158971548080444, 0.09225329756736755])
